...
const work = [
  {
    ...
    description: "Samsung's Olympic presence was more than sponsorship. It was a signal that smartphones were becoming part of everyday life, global connection, and cultural participation.",
  ...
  },
  {
    ...
    description: 'Smartphones and wearables were becoming personal, expressive, and visible. This work put Samsung into the fashion conversation at exactly the moment technology started becoming style.',
  ...
  },
  {
    ...
    description: 'A branded content series connecting Samsung Galaxy Note with fashion media, creativity, and behind-the-scenes access during Paris Fashion Week.',
  ...
  },
  {
    ...
    description: "Samsung invited followers to submit Valentine's messages, then transformed selected notes into custom illustrations created on Galaxy Note devices using touchscreen technology and the S Pen.",
  ...
  },
  {
    ...
    description: "A playful branded content program that brought Canon PIXMA into the DIY and creator conversation, using BuzzFeed's editorial style to make printing feel social, nostalgic, and fun.",
  ...
  },
  {
    ...
    description: "Canon's Project Imagination platform connected cameras, Hollywood talent, audience participation, and digital storytelling in a way that made creativity feel collaborative.",
    ...
    <div className="site-shell">
      <header className="nav">
        ...
        <nav>
          ...
          <NavLink to="/pet-projects">Pet Projects</NavLink>
...
function Home() {
  return (
    <Layout>
      <main>
        <section className="hero no-photo">
        ...
        <section className="home-statement">
          <p className="section-kicker">01 — The Through Line</p>
          <h2>Brands, systems, and the moments people remember.</h2>
          <p>
            My work has moved across global launches, content partnerships, regulated categories,
            independent consulting, and AI-enabled operations. The shape changes. The instinct stays the same:
            understand the moment, find the friction, and build the thing that helps the work move.
          </p>
          <Link to="/eras" className="text-link">Explore the eras <ArrowRight size={16} /></Link>
        </section>
      </main>
    </Layout>
  )
    ...
    <Layout>
      <main className="page">
        <section className="page-hero">
          ...
          <h1>The proof.</h1>
          <p>Campaigns, partnerships, launches, and content programs that put brands into the cultural conversation.</p>
        </section>
        ...
        <section className="work-list">
          ...
          <article className="work-detail text-only">
            ...
            <div className="work-content">
              ...
              <p>A celebrity-led brand launch that placed Air Optix Colors inside beauty, style, and entertainment media conversation.</p>
...
function Eras() {
  const eras = [
    { title: 'The Smartphone Era', body: 'Samsung, London 2012, Galaxy devices, fashion partnerships, and the years when the phone became the center of modern life.', visual: 'smartphone' },
    { title: 'The Content Era', body: 'Canon, BuzzFeed, Project Imagination, and the moment brands stopped only advertising and started publishing, partnering, and entertaining.', visual: 'content' },
    { title: 'The Regulated Era', body: 'Novartis and pharmaceutical media, where the work had to be precise, compliant, fast-moving, and carefully aligned.', visual: 'regulated' },
    { title: 'The Independent Era', body: 'Building a consulting practice from the ground up, owning the client relationship, the strategy, the execution, and the outcome.', visual: 'independent' },
    { title: 'The AI Operations Era', body: 'Forecasting, budget management, campaign monitoring, and workflow systems built for the next version of how marketing teams operate.', visual: 'ai' },
  ]
    ...
    <Layout>
      <main className="page">
        <section className="page-hero">
          ...
          <p>
            The work looks different depending on the chapter. The pattern is the same:
            step into the change, understand what is shifting, and build what helps the work move.
          </p>
        </section>
        ...
        <section className="eras-list">
          {eras.map((era, index) => (
            <article className="era-block" key={era.title}>
              <div className={`era-visual ${era.visual}`} aria-hidden="true"></div>
              <div>
    ...
    <Layout>
      <main className="page">
        <section className="page-hero">
          ...
          <h1>The toolkit.</h1>
          <p>The campaign work gets attention. The systems are how the work scales.</p>
        </section>
...
function PetProjects() {
  return (
    <Layout>
      <main className="page">
        <section className="page-hero">
          <p className="section-kicker">04 — Pet Projects</p>
          <h1>The side quests.</h1>
          <p>
            Not every project starts with a Fortune 500 budget. Some start closer to home — with a family business,
            a real audience, and the same question I ask everywhere: how do we make people care?
          </p>
        </section>

        <section className="pet-project">
          <div className="pet-images">
            <img src="/assets/alpaca-family.png" alt="Family alpaca farm photo" />
            <img src="/assets/alpaca-herd.png" alt="Alpacas on a family farm" />
          </div>
          <div className="pet-copy">
            <p className="kicker">Family Alpaca Farm · Paid Media Initiative</p>
            <h2>Turning a family farm into a local discovery story.</h2>
            <p>
              Ran a paid media initiative for my family's alpaca farm, translating a charming offline experience
              into a digital campaign designed to drive awareness, interest, and local visits.
            </p>
            <p>
              The work blended practical audience targeting with the emotional side of the brand: the animals,
              the setting, the family story, and the simple joy of discovering something unexpected nearby.
            </p>
          </div>
        </section>
      </main>
